-- =====================================================
-- Archon Complete Database Setup - Kubernetes Edition
-- =====================================================
-- This script is adapted for self-hosted PostgreSQL in Kubernetes.
-- RLS (Row Level Security) policies have been removed as they rely
-- on Supabase-specific auth.role() functions.
--
-- For K8s deployment, authorization is handled at the application layer.
-- =====================================================
...
-- NOTE: RLS policies removed for K8s deployment (auth.role() is Supabase-specific)
...
-- NOTE: RLS policies removed for K8s deployment
...
-- NOTE: RLS policies for knowledge base tables removed for K8s deployment
...
-- NOTE: RLS policies for migrations table removed for K8s deployment
...
-- NOTE: RLS policies for projects module removed for K8s deployment
...
-- =====================================================
-- SETUP COMPLETE - KUBERNETES EDITION
-- =====================================================
-- Your Archon database is now fully configured for K8s deployment!
--
-- RLS policies have been removed as they rely on Supabase-specific
-- auth.role() functions. Authorization is handled at the application layer.
--
-- Next steps:
-- 1. Add your OpenAI API key via the Settings UI or environment variable
